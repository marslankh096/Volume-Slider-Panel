...
public class GlitterThemeAdapter extends RecyclerView.Adapter<GlitterThemeAdapter.Holder> {
    ...
    public void onBindViewHolder(Holder holder, final int i) {
        ...
        with.load("file:///android_asset/glitter/" + (i + 1) + ".webp").into(holder.setthumb);
        holder.laymain.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                GlitterThemeAdapter.this.onMyCommonItem.OnMyClick1(i, GlitterThemeAdapter.this.allview.get(i));
            }
        });
        if (i == this.selected) {
